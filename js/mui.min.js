    ...
    i.uuid = 0,
        ...
        i.extend = function () {
            var a, c, d, e, f, g, h = arguments[0] || {},
                ...
                k = arguments.length,
                l = !1;
            for ("boolean" == typeof h && (l = h, h = arguments[j] || {}, j++), "object" == typeof h || i.isFunction(h) || (h = {}), j === k && (h = this, j--); k > j; j++) if (null != (a = arguments[j])) for (c in a) d = h[c],
                e = a[c],
            h !== e && (l && e && (i.isPlainObject(e) || (f = i.isArray(e))) ? (f ? (f = !1, g = d && i.isArray(d) ? d : []) : g = d && i.isPlainObject(d) ? d : {}, h[c] = i.extend(l, g, e)) : e !== b && (h[c] = e));
            return h
        },
        i.noop = function () {},
        i.slice = [].slice,
    ...
    function (a, b) {
        ...
        var c = Math.round,
            ...
            p = function (a) {
                ...
                for (var d = 0, e = 0, f = 0; b > f;) d += a[f].pageX,
                    e += a[f].pageY,
                    f++;
                return {
                    x: c(d / b),
            ...
            if (window.__NWin_Enable__ !== !1) {
                var c = "mui-plus-pullrefresh",
                    ...
                    k = a.Class.extend({
                        ...
                        setStopped: function (a) {
                            this.stopped = !! a,
                                this.stopped ? (this.disablePullupToRefresh(), this.disablePulldownToRefresh()) : (this.enablePullupToRefresh(), this.enablePulldownToRefresh())
                        },
                ...
                updateTranslate: function (b) {
                    if (b !== this.lastTranslateX) {
                        if (this.slideIn) {
                            ...
                            this.setTranslateX(b),
                                b >= 0 ? (this.leftShowing = !0, this.rightShowing = !1, b > 0 && (this.offCanvasLeft && a.each(this.offCanvasLefts, function (a, b) {
    ...
    function (a, b, c, d) {
        ...
        var t = function (a, b, d) {
                if (!("show" === d && a.classList.contains(l) || "hide" === d && !a.classList.contains(l))) {
                    ...
                    var f = !1;
                    (a.classList.contains(i) || a.classList.contains(g)) && (a.classList.contains(g) ? (f = !0, r.classList.add(k)) : r.classList.add(j)),
                        u(a, "block"),
                        a.offsetHeight,
                        a.classList.add(l),
                ...
                if (z) {
                    ...
                    if ("open" === d) {
                        ...
                        if (E(A, j), i = "toLeft" === sliderDirection ? buttonsRight : buttonsLeft, "undefined" != typeof i) {
                            for (var k = null, l = 0; l < i.length; l++) k = i[l],
                                E(k, j);
            ...
            i = a.Numbox = a.Class.extend({
                ...
                initEvent: function () {
                    ...
                    b.plus.addEventListener(c, function (c) {
                        var e = parseFloat(b.input.value) + b.options.step;
                        ...
                        b.input.addEventListener(d, function (c) {
                            b.checkValue();
                            var e = parseFloat(b.input.value);
                ...
                getValue: function () {
                    var a = this;
                    return parseFloat(a.input.value)
                },
                checkValue: function () {
                    var a = this,
                        b = a.input.value;
                    if (null == b || "" == b || isNaN(b)) a.input.value = a.options.min || 0,
                        ...
                        var b = parseFloat(b);
                        null != a.options.max && !isNaN(a.options.max) && b >= parseFloat(a.options.max) ? (b = a.options.max, a.plus.disabled = !0) : a.plus.disabled = !1,
                            null != a.options.min && !isNaN(a.options.min) && b <= parseFloat(a.options.min) ? (b = a.options.min, a.minus.disabled = !0) : a.minus.disabled = !1,
                            a.input.value = b
                    }
                },
